...
export const mockSubmissions: SubmissionRecord[] = [
  {
    ...
    challengeRepositoryFullName: "vercel/next.js",
    userId: "user-1",
    status: "draft",
    notes:
      "Repro is stable locally. Still narrowing the loading boundary branch before I open the PR.",
    githubForkUrl: "https://github.com/morganlee/next.js",
  ...
  },
  {
    ...
    challengeRepositoryFullName: "prisma/prisma",
    userId: "user-1",
    status: "submitted",
    notes:
      "PR includes the message rewrite plus a small regression assertion around the CLI error output.",
    githubPrUrl: "https://github.com/prisma/prisma/pull/21488",
    githubForkUrl: "https://github.com/morganlee/prisma",
  ...
  },
  {
    ...
    challengeRepositoryFullName: "withastro/astro",
    userId: "user-1",
    status: "under_review",
    notes:
      "Maintainer asked for one more docs screenshot before merge. PR is otherwise ready.",
    githubPrUrl: "https://github.com/withastro/astro/pull/14631",
    githubForkUrl: "https://github.com/morganlee/astro",
  ...
  },
  {
    ...
    challengeSlug: "eslint-rule-meta-doc-link",
    challengeTitle: "Fix a missing docs link in rule metadata output",
    challengeRepositoryFullName: "eslint/eslint",
    userId: "user-2",
    status: "accepted",
    notes:
      "Merged cleanly after one metadata naming tweak. This is the shape verified scoring should eventually listen to.",
    githubPrUrl: "https://github.com/eslint/eslint/pull/18764",
    githubForkUrl: "https://github.com/priyashah/eslint",
  ...
  },
  {
    ...
    challengeSlug: "django-admin-empty-state",
    challengeTitle: "Improve the empty state copy in Django admin filters",
    challengeRepositoryFullName: "django/django",
    userId: "user-3",
    status: "rejected",
    notes:
      "The fix was directionally right, but it needs a narrower scope and a test before the next attempt.",
    githubPrUrl: "https://github.com/django/django/pull/19402",
    githubForkUrl: "https://github.com/jordankim/django",
